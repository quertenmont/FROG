...
public class Event_SimHit extends Base{
	 
	public float x; public float y; public float z; public float charge;
    byte processType;
 

	public int ChunkId() {	return 11010; }
	public boolean isCompactible() {return true;}    

	public String toString() {
		return String.format("Event_SimHit [x=%s, y=%s, z=%s, charge=%s]", x, y, z, charge);
	}
